        ...
        <div className="md:h-[calc(100vh-88px)] max-h-[800px] max-w-7xl mx-auto flex flex-col justify-center items-center gap-5 md:gap-0 py-8 md:py-20 px-5">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start w-full gap-10 md:gap-0 z-10">
                <div className="flex-1 space-y-3 md:space-y-5 lg:space-y-7">
                    <h1 className="text-white text-xl md:text-4xl font-bold">I am Kausar Ahammed</h1>
                    ...
                    <div className="flex items-center gap-3 md:gap-5">
                        <a
                            href="https://drive.google.com/file/d/10YM9F7WdBQz5306LAHp1pDQRKK0vdVVl/view?usp=sharing"
                            target="_blank"
